...
- [ ] Заменить фиксированный список из восьми пар на workspace-scoped market universe:
...
- [ ] Добавить API каталога доступных инструментов по активным проверенным подключениям
...
- [ ] Добавить на страницу «Рынок» действие «Добавить пары» с modal/drawer: поиск,
...
- [ ] Перекомпоновать страницу «Настройки»: убрать смешение несвязанных блоков, собрать
